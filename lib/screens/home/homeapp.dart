...
import 'package:dejabrew/screens/home/profile.dart';
import 'package:dejabrew/widgets/coffeetypes.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //               width: 225.0,
  //               decoration: BoxDecoration(
  //                   borderRadius: BorderRadius.circular(25.0), color: gld),
  //               child: Center(
  //                 child: Text(
  //                   'Order Now',
  //                   style: TextStyle(
